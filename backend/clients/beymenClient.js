...
async function getProducts() {
  if (MOCK) {
    ...
    return {
      products: [
        { sku: "SKU-IPHONE15", name: "iPhone 15 Black (Beymen)", quantity: 41 },
        { sku: "SKU-MACBOOKPRO", name: "MacBook Pro 14 (Beymen)", quantity: 13 },
        { sku: "SKU-AIRPODSPRO", name: "AirPods Pro 2 (Beymen)", quantity: 114 }
      ]
    };
  }
  // TODO: Real API call
