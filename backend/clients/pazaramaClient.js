...
async function getProducts() {
  if (MOCK) {
    ...
    return {
      products: [
        { sku: "SKU-IPHONE15", name: "iPhone 15 Black (Pazarama)", quantity: 39 },
        { sku: "SKU-MACBOOKPRO", name: "MacBook Pro 14 (Pazarama)", quantity: 7 },
        { sku: "SKU-AIRPODSPRO", name: "AirPods Pro 2 (Pazarama)", quantity: 102 }
      ]
    };
  }
  // TODO: Real API call
