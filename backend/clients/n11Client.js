...
async function getProducts() {
  if (MOCK) {
    ...
    return {
      products: [
        { sku: "SKU-IPHONE15", name: "iPhone 15 Black (N11)", quantity: 37 },
        { sku: "SKU-MACBOOKPRO", name: "MacBook Pro 14 (N11)", quantity: 8 },
        { sku: "SKU-AIRPODSPRO", name: "AirPods Pro 2 (N11)", quantity: 108 }
      ]
    };
  }
  // TODO: Real API call
