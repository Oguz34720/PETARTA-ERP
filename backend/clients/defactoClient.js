...
async function getProducts() {
  if (MOCK) {
    ...
    return {
      products: [
        { sku: "SKU-IPHONE15", name: "iPhone 15 Black (Defacto)", quantity: 40 },
        { sku: "SKU-MACBOOKPRO", name: "MacBook Pro 14 (Defacto)", quantity: 12 },
        { sku: "SKU-AIRPODSPRO", name: "AirPods Pro 2 (Defacto)", quantity: 110 }
      ]
    };
  }
  // TODO: Real API call
